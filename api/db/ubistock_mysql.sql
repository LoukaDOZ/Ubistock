...
ALTER TABLE `company`
  ...
  ADD UNIQUE KEY `root_id` (`root_id`),
  ADD KEY `ceo_id` (`ceo_id`);

--
-- Index pour la table `company_group`
--
...
--
-- Index pour la table `company_group_member`
--
ALTER TABLE `company_group_member`
  ADD PRIMARY KEY (`company_group_id`,`company_user_id`),
  ADD KEY `company_user_id` (`company_user_id`);

--
-- Index pour la table `company_group_storage`
--
ALTER TABLE `company_group_storage`
  ADD UNIQUE KEY `company_group_id` (`company_group_id`,`storage_id`),
  ADD KEY `storage_id` (`storage_id`);

--
-- Index pour la table `company_log`
--
ALTER TABLE `company_log`
  ADD PRIMARY KEY (`company_log_id`),
  ADD KEY `company_user_id` (`company_user_id`);
...
--
-- Index pour la table `resource_minimum`
--
...
--
-- Index pour la table `storage_minimum`
--
ALTER TABLE `storage_minimum`
  ADD UNIQUE KEY `storage_id` (`storage_id`,`resource_name`,`resource_type`) USING HASH,
  ADD KEY `storage_ref` (`storage_id`);
...
--
ALTER TABLE `company`
  ADD CONSTRAINT `ceo_id` FOREIGN KEY (`ceo_id`) REFERENCES `company_user` (`company_user_id`),
  ADD CONSTRAINT `company_root` FOREIGN KEY (`root_id`) REFERENCES `storage` (`storage_id`);
